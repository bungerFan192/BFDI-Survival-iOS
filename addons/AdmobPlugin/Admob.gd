...
@export_flags(" ") var enabled_networks = 0
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_banner_ads.is_empty():
				...
				_plugin_singleton.show_banner_ad(_active_banner_ads.last_key())
		else:
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_banner_ads.is_empty():
				...
				_plugin_singleton.hide_banner_ad(_active_banner_ads.last_key())
		else:
			if _active_banner_ads.has_key(a_ad_id):
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_banner_ads.is_empty():
				...
				_plugin_singleton.remove_banner_ad(_active_banner_ads.erase_last())
		else:
			if _active_banner_ads.has_key(a_ad_id):
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_interstitial_ads.is_empty():
				...
				_plugin_singleton.show_interstitial_ad(_active_interstitial_ads.last_key())
		else:
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_interstitial_ads.is_empty():
				...
				_plugin_singleton.remove_interstitial_ad(_active_interstitial_ads.erase_last())
		else:
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_rewarded_ads.is_empty():
				...
				_plugin_singleton.show_rewarded_ad(_active_rewarded_ads.last_key())
		else:
	...
	if _plugin_singleton == null:
		...
		if a_ad_id.is_empty():
			if _active_rewarded_ads.is_empty():
				...
				_plugin_singleton.remove_rewarded_ad(_active_rewarded_ads.erase_last())
		else:
